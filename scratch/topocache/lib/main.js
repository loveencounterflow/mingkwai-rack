...
(function() {
  var CND, CS, FS, LTSORT, QUERYSTRING, URL, badge, debug, echo, help, info, log, rpr, step, timestamp_providers, urge, warn, whisper,
    slice = [].slice;
  ...
  this.register = function(me, precedent, consequent, fix) {
    var consequent_url, precedent_url, rc_key;
    precedent_url = CND.isa_list(precedent) ? this.as_url.apply(this, [me].concat(slice.call(precedent))) : precedent;
    consequent_url = CND.isa_list(consequent) ? this.as_url.apply(this, [me].concat(slice.call(consequent))) : consequent;
  ...
  this.get_fix = function(me, precedent, consequent, fallback) {
    var R, consequent_url, precedent_url, rc_key;
    precedent_url = CND.isa_list(precedent) ? this.as_url.apply(this, [me].concat(slice.call(precedent))) : precedent;
    consequent_url = CND.isa_list(consequent) ? this.as_url.apply(this, [me].concat(slice.call(consequent))) : consequent;
    rc_key = this._get_rc_key(me, precedent_url, consequent_url);
  ...
  this.as_url = function(me, protocol, payload) {
    return URL.format({
      protocol: protocol,
      slashes: true,
      pathname: payload
